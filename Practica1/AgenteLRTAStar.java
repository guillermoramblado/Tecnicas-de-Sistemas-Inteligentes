...
public class AgenteLRTAStar extends AbstractPlayer{
	...
	public ACTIONS LRTAStar(StateObservation stateObs) {
    	...
    	//actualizo la heuristica del padre usando el 1º mejor hijo
    	...
    	return mejor_hijo.nodo.accion; //controlar el que no este bien orientado y haya que desplazarse dos veces...
	}
	...
	public ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
		if(!repetiraccion) {
			...
			ultima_accion=LRTAStar(stateObs);
