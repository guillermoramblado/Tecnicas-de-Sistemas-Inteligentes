...
public class Vector2dNew
{
	...
	public boolean equals(Object o) {
        if (o instanceof Vector2dNew) {
            Vector2dNew v = (Vector2dNew) o;
            return x == v.x && y == v.y;
        } else {
            return false;
        }
     ...
     */
    public Vector2dNew(Vector2dNew v) {
        this.x = v.x;
        this.y = v.y;
    }
    
    public Vector2dNew(Vector2d v) {
        this.x = v.x;
        this.y = v.y;
    }
     ...
     */
    public Vector2dNew copy() {
        return new Vector2dNew(x,y);
    }
     ...
     */
    public Vector2dNew add(Vector2dNew v) {
        this.x += v.x;
        this.y += v.y;
        return this;
    }
     ...
     */
    public Vector2dNew add(double x, double y) {
        this.x += x;
        this.y += y;
        return this;
    }
     ...
     */
    public Vector2dNew add(Vector2dNew v, double w) {
        // weighted addition
        this.x += w * v.x;
        this.y += w * v.y;
        return this;
     ...
     */
    public Vector2dNew wrap(double w, double h) {
//        w = 2 * w;
//        h = 2 * h;
        x = (x + w) % w;
        y = (y + h) % h;
     ...
     */
    public Vector2dNew subtract(Vector2dNew v) {
        this.x -= v.x;
        this.y -= v.y;
        return this;
    }
     ...
     */
    public Vector2dNew subtract(double x, double y) {
        this.x -= x;
        this.y -= y;
        return this;
    }
     ...
     */
    public Vector2dNew mul(double fac) {
        x *= fac;
        y *= fac;
        return this;
    }
     ...
     */
    public double scalarProduct(Vector2dNew v) {
        return x * v.x + y * v.y;
    }
     ...
     */
    public double sqDist(Vector2dNew v) {
     ...
     */
    public double dist(Vector2dNew v) {
     ...
     */
    public double dot(Vector2dNew v) {
        double tot = this.x * v.x + this.y * v.y;
        return tot;
    }

    public Vector2dNew unitVector()
    {
        double l = this.mag();
        if(l > 0)
        {
            return new Vector2dNew(this.x/l,this.y/l);
        }
        else return new Vector2dNew(1,0);
    }
